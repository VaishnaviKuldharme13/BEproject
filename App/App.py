...
# sql connector
connection = pymysql.connect(host='sql6.freesqldatabase.com',user='sql6697850',password='HzKpz2GQS7',db='sql6697850')
...
def run():
    ...
    link = '<b>Built with 🤍 by <a href="https://dnoobnerd.netlify.app/" style="text-decoration: none; color: #021659;">students</a></b>' 
    ...
    # Create the DB
    db_sql = """CREATE DATABASE IF NOT EXISTS sql6697850;"""
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        st.subheader("**About PROMATCH*")

        st.markdown('''

        <p align='justify'>
            Are you ready to stand out in today's competitive job market? Welcome, your ultimate tool for optimizing your resume and unlocking new career opportunities. Crafting a winning resume is more than just listing your experiences and skills,it's about presenting yourself effectively to potential employers. With Resume Analyzer, you can ensure that your resume is not only visually appealing but also strategically tailored to catch the attention of hiring managers and applicant tracking systems (ATS).
        </p>

        <p align="justify">
            <b>How to use it: -</b> <br/><br/>
            <b>User -</b> <br/>
            In the Side Bar choose yourself as user and fill the required fields and upload your resume in pdf format and our advanced algorithm goes to work, analyzing every aspect to provide you with comprehensive feedback. From ATS compatibility and keyword optimization to formatting suggestions and content relevance, our analysis covers it all also receive personalized recommendations on how to improve your resume based on the analysis results. Whether it's tweaking the layout, adding relevant keywords, or highlighting your key achievements, we'll guide you every step of the way to create a standout resume.
Just sit back and relax our tool will do the magic on it's own.<br/><br/>
            <b>Feedback -</b> <br/>
            A place where user can suggest your valuable feedback with us for further improvement.<br/><br/>
            <b>Admin -</b> <br/>
            For login use <b>admin</b> as username and <b>admin@resume-analyzer</b> as password.<br/>
            Adim account will manage user data securely, and ensure the smooth operation of our platform.Admin will get all applicant’s data into tabular format can download user’s data into csv file, view all saved uploaded pdf in Uploaded Resume folder It will load all the required stuffs and perform analysis.
        </p><br/><br/>
